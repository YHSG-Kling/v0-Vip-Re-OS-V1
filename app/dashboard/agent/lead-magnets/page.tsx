...
export default function AgentLeadMagnetsPage() {
  ...
  useEffect(() => {
    async function loadUser() {
      ...
      if (!profile || !["agent", "admin", "broker", "superadmin"].includes(profile.user_type)) {
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-2xl font-bold leading-none">
              {view === "library" ? "My Lead Magnets" : view === "new" ? "New Lead Magnet" : selected?.name ?? "Lead Magnet Detail"}
            </h1>
