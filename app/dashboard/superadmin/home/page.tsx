...
const GROUPS: ToolGroup[] = [
  ...
  },
  {
    title: "Billing", icon: CreditCard, tools: [
      ...
      { label: "Affiliates — external partners", href: "/dashboard/superadmin/affiliates", cap: "billing",
        desc: "External ?ref partners — links, attributed signups, accrued fees, and the mark-paid ledger." },
      { label: "Coupons & save-offers", href: "/dashboard/superadmin/coupons", cap: "billing",
        desc: "Signup coupons, Stripe publish, and the retention save-offer — every mutation audited." },
  ...
  },
  {
    title: "Systems", icon: Cog, tools: [
      ...
      { label: "Fleet numbers", href: "/dashboard/superadmin/numbers", cap: "providers",
