...
export const NAVIGATION_BY_ROLE: Record<UserRole, NavigationConfig> = {
  ...
  broker: {
    ...
    commandPaletteItems: [
      { id: 'new-agent', label: 'Add Agent', href: '/dashboard/settings/teams' },
      { id: 'view-reports', label: 'Analytics', href: '/analytics' },
  ...
  admin: {
    sidebarItems: [
      ...
      { id: 'farm-intel', label: 'Farm Intelligence', href: '/dashboard/admin/farm-intelligence', icon: 'Map' },
      ...
      { id: 'provider-intel', label: 'Provider Intelligence', href: '/dashboard/admin/provider-intelligence', icon: 'Network' },
      { id: 'divider2', divider: true },
    ...
    commandPaletteItems: [
      ...
      { id: 'ai-audit', label: 'AI Quality Audit', href: '/admin/ai-audit' },
    ],
  },
