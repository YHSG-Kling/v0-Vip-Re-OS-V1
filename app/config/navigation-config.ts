...
export const NAVIGATION_BY_ROLE: Record<UserRole, NavigationConfig> = {
  agent: {
    sidebarItems: [
      ...
      { id: 'reputation', label: 'Reputation & Advocacy', href: '/dashboard/reputation', icon: 'Star' },
  ...
  broker: {
    sidebarItems: [
      ...
      { id: 'reputation-broker', label: 'Reputation', href: '/dashboard/reputation', icon: 'Star' },
  ...
  isa: {
    sidebarItems: [
      ...
      { id: 'voice-isa', label: 'Voice ISA', href: '/dashboard/voice/isa', icon: 'Mic' },
      { id: 'divider1', divider: true },
      {
        id: 'video-tools',
        label: 'Video Tools',
