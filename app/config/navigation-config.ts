...
export const NAVIGATION_BY_ROLE: Record<UserRole, NavigationConfig> = {
    ...
    sidebarItems: [
      ...
      { id: 'credit-pipeline', label: 'Credit Pipeline', href: '/credit-pipeline', icon: 'CreditCard' },
      {
        ...
        children: [
          ...
          { id: 'sphere-radar', label: 'Referrals & Opportunity', href: '/past-clients?tab=radar' },
          { id: 'sphere-reputation', label: 'Reviews & Reputation', href: '/past-clients?tab=reputation' },
          { id: 'sphere-portal', label: 'Portal Actions', href: '/past-clients?tab=portal' },
        ],
      },
  ...
  broker: {
    sidebarItems: [
      ...
      { id: 'reputation-broker', label: 'Reputation', href: '/past-clients?tab=reputation', icon: 'Star' },
