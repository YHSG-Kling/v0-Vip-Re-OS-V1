...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const { error: team_heatmap_snapshot_log_error } = await supabase
      .from("automation_errors")
      .insert({ brokerage_id: null, workflow_name: "team-heatmap-snapshot", error_message: err.message, severity: "error", created_at: ranAt })
    if (team_heatmap_snapshot_log_error) {
      ...
      console.error("[TeamHeatmapSnapshot] automation_errors insert refused:", team_heatmap_snapshot_log_error.message)
    }
