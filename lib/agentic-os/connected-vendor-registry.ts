...
export const CONNECTED_CAPABILITY_REGISTRY: Record<ConnectedCapability, ConnectedCapabilityDef> = {
  ...
  crm_contact_sync:          { capability: "crm_contact_sync",          verb: "UPDATE",  scope: "crm:write",         domain: "crm",            mutates: true,  purpose: "Sync OUT a contact's details to the brokerage's connected CRM (egress only — update contact/details).", inputs: ["contactId"], connections: ["gohighlevel", "lofty", "followupboss"] },
