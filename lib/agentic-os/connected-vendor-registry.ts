...
export const CONNECTED_CAPABILITY_REGISTRY: Record<ConnectedCapability, ConnectedCapabilityDef> = {
  ...
  accounting_sync:           { capability: "accounting_sync",           verb: "UPDATE",  scope: "finance:write",     domain: "finance",        mutates: true,  purpose: "Sync an invoice or journal entry to the connected accounting system.", inputs: ["entityType", "entityId"], connections: ["quickbooks", "stripe", "plaid"] },
