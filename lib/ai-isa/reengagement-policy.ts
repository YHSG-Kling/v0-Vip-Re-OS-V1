 ...
 * when the ISA may continue. Mirrors the inline checks in runGhostReengagement exactly
 * (representation / inactive / reengage-disallowed / opted-out, then reply-received).
 */
export function ghostReengagementStopReason(input: GhostStopInput): GhostStopReason | null {
