...
export const COMPOSITION_GEOMETRY: Record<string, RegisteredGeometry> = {
  ...
  AgentExplainerReel: { width: 1080, height: 1080, fps: 30, duration_frames: 2880 },
  AgentTalkingHeadReel: { width: 1080, height: 1080, fps: 30, duration_frames: 2820 },
  ...
  ComingSoonReel: { width: 1080, height: 1080, fps: 30, duration_frames: 1500 },
  DoorHanger: { width: 1350, height: 3375, fps: 30, duration_frames: 1 },
  EquityReportReel: { width: 1080, height: 1080, fps: 30, duration_frames: 2430 },
  ExplainerAnimReel: { width: 1080, height: 1080, fps: 30, duration_frames: 2880 },
  JustListedReel: { width: 1080, height: 1920, fps: 30, duration_frames: 1500 },
  JustListedReelHorizontal: { width: 1920, height: 1080, fps: 30, duration_frames: 1530 },
  JustListedReelSquare: { width: 1080, height: 1080, fps: 30, duration_frames: 1470 },
  JustSoldReelSquare: { width: 1080, height: 1080, fps: 30, duration_frames: 1470 },
  ...
  ListingSectionReel: { width: 1920, height: 1080, fps: 30, duration_frames: 1350 },
  MarketUpdateReel: { width: 1080, height: 1080, fps: 30, duration_frames: 2370 },
  // Lane 78D — the CAP (20 min), not the length: Root.tsx's calculateMetadata
  // sets the real durationInFrames from the narration
  // (lib/video/memory-video-composition.ts memoryVideoDurationFrames). Row
  // lands with supabase/migrations/m659-memory-video-reel-composition.sql.
  MemoryVideoReel: { width: 1920, height: 1080, fps: 30, duration_frames: 36000 },
  NeighborhoodSpotlightReel: { width: 1080, height: 1080, fps: 30, duration_frames: 1950 },
  NewsletterDigestThumb: { width: 1200, height: 630, fps: 30, duration_frames: 1 },
  NewsletterDigestVideo: { width: 1080, height: 1920, fps: 30, duration_frames: 1950 },
  OpenHouseAnnounceReel: { width: 1080, height: 1080, fps: 30, duration_frames: 1500 },
  PartnersMeetingReel: { width: 1920, height: 1080, fps: 30, duration_frames: 3720 },
  PhotoWalkthroughReel: { width: 1080, height: 1080, fps: 30, duration_frames: 2850 },
  ...
  ProductPromoReel: { width: 1080, height: 1920, fps: 30, duration_frames: 3720 },
  TeammateExplainerReel: { width: 1080, height: 1080, fps: 30, duration_frames: 2865 },
  TestimonialReel: { width: 1080, height: 1080, fps: 30, duration_frames: 1920 },
