...
//   4. Tenant override        (grant_trial → allow; disable → deny)  [most-specific scope]
//   5. Plan / tier access     (the plan the customer bought)
//   6. Runtime usage cap       (limit for this billing period)
//
...
export function resolveEntitlement(i: EntitlementInputs): EntitlementDecision {
  ...
  // 4. Tenant override (most-specific scope already selected by the caller).
