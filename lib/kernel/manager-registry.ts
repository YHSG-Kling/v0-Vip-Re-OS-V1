...
export const MAINTENANCE_DOMAINS: Record<string, { manager: ManagerKey; proof: string; what: string }> = {
  ...
  mobile_approval_push:       { manager: "campaign_orchestrator", proof: "test:mobile-approval", what: "Thumb-friendly approval queue + breached/due approvals pushed to the broker's notifications (approval latency is the egress's critical path)" },
