...
export function buildDemoSeedPlan(
  ...
  const contacts = [
    ...
    // Omar rekeyed 2026-08-31 (owner: "investor is a persona and not a contact type"):
    // the investing moved from contact_type onto contact_persona (m589).
    { id: CONTACT(10), first_name: "Omar",   last_name: "Demofield",  contact_type: "buyer", contact_persona: "investor", status: "active", lead_temperature: "warm", lifecycle_state: "converted",         budget_min: 250000, budget_max: 900000, city: "Austin", state: "TX", zip_code: "78741", source: "referral",    engagement_score: 78, notes: `[${DEMO_TAG}] Buy-and-hold investor, 4 doors so far. Under contract on Model Home Loop; wants 2 more this year at 6%+ cap.`, last_contacted_at: daysAgo(1), next_followup_at: daysAhead(5), created_at: daysAgo(200) },
