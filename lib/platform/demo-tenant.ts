...
export function buildDemoSeedPlan(
  ...
  const leads = [
    { id: LEAD(1), first_name: "Tara",   last_name: "Demopolis",  lead_type: "buyer",  lead_stage: "new",       lead_temperature: "hot",  lead_score: 86, urgency_level: "high",   source: "website",     city: "Austin", state: "TX", zip_code: "78704", lifecycle_state: "new",            notes: `[${DEMO_TAG}] Filled out the home-search form twice this week — searching South Austin under $500K.`, created_at: daysAgo(1) },
    { id: LEAD(2), first_name: "Victor", last_name: "Sampleson",  lead_type: "seller", lead_stage: "new",       lead_temperature: "warm", lead_score: 64, urgency_level: "medium", source: "home_value",  city: "Buda", state: "TX", zip_code: "78610", lifecycle_state: "unconsented",    notes: `[${DEMO_TAG}] Ran the home-value tool on 44 Placeholder Pass. No consent yet — awaiting opt-in.`, created_at: daysAgo(2) },
    { id: LEAD(3), first_name: "Ingrid", last_name: "Mockford",   lead_type: "buyer",  lead_stage: "qualified", lead_temperature: "hot",  lead_score: 90, urgency_level: "high",   source: "open_house",  city: "Austin", state: "TX", zip_code: "78745", lifecycle_state: "isa_qualifying", notes: `[${DEMO_TAG}] AI ISA qualified: pre-approval in hand, 60-day timeline, touring this weekend.`, created_at: daysAgo(6) },
    { id: LEAD(4), first_name: "Hank",   last_name: "Exampleman", lead_type: "seller", lead_stage: "qualified", lead_temperature: "warm", lead_score: 72, urgency_level: "medium", source: "farm_mail",   city: "Manor", state: "TX", zip_code: "78653", lifecycle_state: "isa_qualifying", notes: `[${DEMO_TAG}] Responded to the farm postcard — estate sale, needs probate guidance before listing.`, created_at: daysAgo(10) },
    { id: LEAD(5), first_name: "Renee",  last_name: "Testfield",  lead_type: "buyer",  lead_stage: "new",       lead_temperature: "cold", lead_score: 35, urgency_level: "low",    source: "social",      city: "Kyle", state: "TX", zip_code: "78640", lifecycle_state: "new",            notes: `[${DEMO_TAG}] Instagram lead magnet download (first-time buyer guide). Browsing 6+ months out.`, created_at: daysAgo(14) },
    { id: LEAD(6), first_name: "Paulo",  last_name: "Demovista",  lead_type: "buyer",  lead_stage: "converted", lead_temperature: "warm", lead_score: 70, urgency_level: "medium", source: "referral",    city: "Austin", state: "TX", zip_code: "78702", lifecycle_state: "converted",      notes: `[${DEMO_TAG}] Converted to contact after discovery call — see CRM record.`, converted_at: daysAgo(3), created_at: daysAgo(18) },
  ].map((l, i) => ({
    ...base,
    ...l,
