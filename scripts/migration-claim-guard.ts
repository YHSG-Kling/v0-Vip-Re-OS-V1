...
import { claimOf, type Claim } from "./migration-status"

export { claimOf, type Claim }
...
// claimOf / Claim moved to scripts/migration-status.ts (§1.1, lane 74C,
// 2026-09-18) — the survivor a second script (hidden-wire-census.ts's (d)
// ratchet) can import without executing this file's whole guard suite as a
// side effect. Re-exported above so this file's own behavior is unchanged.
