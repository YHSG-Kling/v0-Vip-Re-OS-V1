 ...
 * it is committed.
 *
 * MEASURED AT GENERATION: 232 agents(id) columns across 223 tables, 38 agent-ish users(id) columns across 36 tables, 167 contact_id tables.
 *
 * ── PROVENANCE — this file is MACHINE-WRITTEN. Do not hand-edit it. ──────────
 * generated: 2026-09-09
 * source: public.live_foreign_keys_json()
 * body-sha256: 31c737fdc356527830e97f8f899ffadeb8b487e035e41c11b0c2a753c293c981
 *
...
export const AGENT_FK_COLUMNS: Record<string, string[]> = {
  ...
  agent_retention_scores: ["agent_id"],
  agent_reviews: ["agent_id"],
  agent_step_completions: ["agent_id"],
  agent_tax_profile: ["agent_id"],
  ...
  contact_consent_events: ["agent_id"],
  ...
  investor_deal_matches: ["agent_id"],
  ...
  listing_presentations: ["agent_id"],
  ...
  podcast_show_settings: ["agent_id"],
  podcast_templates: ["agent_id"],
  portal_access_logs: ["agent_id"],
  predictive_listing_actions: ["agent_id"],
  predictive_listing_scores: ["agent_id"],
  ...
  scheduled_touchpoints: ["agent_id"],
  ...
  transaction_communications: ["agent_id"],
  ...
  usage_logs: ["agent_id"],
  user_role_assignments: ["agent_id"],
  ...
  wealth_advisor_recommendations: ["agent_id"],
  website_visitors: ["agent_id"],
  weekly_plans: ["agent_id"],
}
...
export const USERS_FK_AGENTISH_COLUMNS: Record<string, string[]> = {
  ...
  facebook_custom_audiences: ["agent_user_id"],
  ...
  subscriber_service_areas: ["agent_user_id"],
  tenant_phone_numbers: ["agent_user_id"],
