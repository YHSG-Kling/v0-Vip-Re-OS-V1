...
export const SCHEMA_SNAPSHOT: Record<string, string[]> = {
  ...
  listings: [
    ...
    "go_live_confirmed_at", "go_live_date", "hoa_dues", "id", "lifecycle_stage", "list_price",
    ...
    "seller_contact_id", "showing_count", "showing_instructions", "slug", "sold_date", "sold_price",
