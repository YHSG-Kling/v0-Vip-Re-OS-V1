...
export const SCHEMA_SNAPSHOT: Record<string, string[]> = {
  ...
  contacts: [
    ...
    "length_of_residence", "life_events", "lifecycle_state", "linkedin_url", "location_id", "mailing_address",
  ...
  listings: [
    ...
    "hoa_dues", "id", "last_price_change_at", "lifecycle_stage", "list_price", "location_id",
