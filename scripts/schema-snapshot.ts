...
export const SCHEMA_SNAPSHOT: Record<string, string[]> = {
  ...
  transactions: [
    "agent_id", "appraisal_completed_date", "appraisal_value", "brokerage_id", "buyer_agent_id",
    "buyer_contact_id", "client_name", "close_date", "commission_amount", "commission_percentage",
    "compliance_passed_at", "contact_id", "contract_date", "contract_date_overridden",
    "contract_date_override_reason", "coordinator_id", "created_at", "deal_name", "deal_type",
    "deleted_at", "estimated_commission", "external_provider_source", "external_provider_transaction_id",
    "health_score", "id", "last_provider_sync_at", "lender_id", "listing_id",
    "listing_offered_commission_percentage", "offer_id", "property_address", "property_city",
    "property_state", "property_zip", "purchase_price", "seller_agent_id", "seller_contact_id",
    "source", "source_family", "stage", "status", "updated_at",
  ],
  offers: [
