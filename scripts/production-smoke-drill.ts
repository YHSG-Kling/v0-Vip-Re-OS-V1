...
// TOMBSTONE (lane 78D, §1.1): SHIM_URL / shimLoader / registerNextHeadersShim
// were declared here (lines 76-152) and MOVED to scripts/next-headers-shim.ts
// (the one survivor; scripts/seed-showcase-tenant.ts needs the same hook).
// Imported back below; behaviour byte-identical.
